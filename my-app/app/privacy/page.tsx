      ...
      <div className="relative">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-16">
            ...
            <div className="bg-[#2C3440]/80 backdrop-blur-sm rounded-2xl p-6 border border-[#3D4451]">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-stone-50 font-semibold mb-1">We Don't Sell Data</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-stone-50 font-semibold mb-1">Secure Storage</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-stone-50 font-semibold mb-1">Data Deletion</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-stone-50 font-semibold mb-1">Transparent Use</h3>
          ...
          <div className="mt-16 bg-[#2C3440]/80 backdrop-blur-sm rounded-2xl p-8 border border-[#3D4451] text-center">
            ...
            <h3 className="text-xl font-bold text-stone-50 mb-3">Privacy Questions or Data Requests?</h3>
