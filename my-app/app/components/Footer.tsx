...
const Footer = () => {
  ...
  return (
    <footer className="relative mt-20">
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black via-stone-900 to-stone-800" />
      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
      
      <div className="relative z-10">
        {/* Newsletter Signup Section - Commented out for now */}
        {/* <div className="bg-gradient-to-r from-amber-500/10 to-purple-500/10 backdrop-blur-sm border-y border-white/10">
          <div className="max-w-7xl mx-auto px-6 py-16">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-white mb-4">Stay in the Reading Loop</h3>
            ...
            <div className="max-w-md mx-auto">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 bg-black/30 border border-white/20 rounded-xl text-white placeholder-stone-400 focus:outline-none focus:border-amber-400/50 focus:ring-2 focus:ring-amber-400/20"
                />
                <button className="px-6 py-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-semibold rounded-xl hover:from-amber-600 hover:to-amber-700 transition-all duration-200 shadow-lg hover:shadow-amber-500/25 flex items-center gap-2">
                  Subscribe
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-6">
                  <Image src="/brand-logo.png" alt="brand" className="w-15 h-15 text-white rounded-full shadow-lg" width={60} height={60} />
                ...
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    <a
                      key={index}
                      href={social.href}
                      className={`w-10 h-10 bg-white/10 backdrop-blur-sm rounded-lg flex items-center justify-center text-stone-400 ${social.color} hover:bg-white/20 transition-all duration-200 border border-white/10`}
            ...
            {/* Legal Links */}
            <div>
              <h4 className="text-lg font-semibold text-white mb-6">Legal & Privacy</h4>
              <ul className="space-y-3">
